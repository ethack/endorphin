...
<div class="[[ Config::get('endorphin.registration') ? '' : 'hide' ]]">
	<div class="form-group">
		<a class="btn btn-lg btn-default btn-block" href="[[ Config::get('endorphin.registration') ? URL::route("user/register") : '#' ]]"><i class="fa fa-sign-up"></i> [[Lang::get('keywords.sign_up')]]</a>
	</div>
</div>
